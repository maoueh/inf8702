#ifndef TP3_APPLICATION_H
#define TP3_APPLICATION_H
...
class Tp3Application : public OpenGlApplication
{
public:
    Tp3Application(CommandLine* commandLine);
    virtual ~Tp3Application();
